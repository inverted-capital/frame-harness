  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md">
      ...
      <p className="mb-4 text-gray-700">
        This is a placeholder for your component. Replace this with the actual
      ...
      <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
        ...
        <p className="text-sm text-blue-700">
          Replace this component with your actual component under test. The
          props shown above are passed from the dashboard and can be used by
          your component.
        </p>
      </div>
    </div>
